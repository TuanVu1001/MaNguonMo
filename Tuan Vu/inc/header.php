...
<?php 
        ...
        if (isset($_GET['search'])){
        	$s= $_GET['search'];
        	$sql="SELECT * FROM tbl_product where name LIKE '%$s%' Order By id DESC ";
        }
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="header_top_right">
			    <div id="wrapper-prodct" class="search_box">
				    <form id="product-search" action="products.php" method="POST">
